...
if (dineroCofla >= 0.6 && dineroCofla < 1) {
    ...
    alert('Lo siento,cofla pobre de mierda no te alcanza para un helado');
}
if (dineroRoberto >= 0.6 && dineroRoberto < 1) {
    ...
    alert('Lo siento, roberto pobre de mierda no te alcanza para un helado');
}
if (dineroPedro >= 0.6 && dineroPedro < 1) {
    ...
    alert('Lo siento,pedro pobre de mierda no te alcanza para un helado');
}